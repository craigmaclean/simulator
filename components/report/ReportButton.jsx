...
export default function ReportButton() {
  return (
    <Button className="bg-[var(--color-gunmetal)] rounded-md mb-4 shadow-md hover:bg-[var(--color-gunmetal)] hover:opacity-[0.90] hover:shadow-xl focus:outline-none transition-all text-xl font-semibold uppercase py-10 px-6">
